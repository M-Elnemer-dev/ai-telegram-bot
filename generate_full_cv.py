...
doc = SimpleDocTemplate(pdf_path, pagesize=letter, rightMargin=25, leftMargin=25, topMargin=25, bottomMargin=25)
styles = getSampleStyleSheet()

t_style = ParagraphStyle('T', parent=styles['Heading1'], fontName='Helvetica-Bold', fontSize=18, textColor=colors.HexColor('#1a365d'), alignment=1, spaceAfter=3)
sub_style = ParagraphStyle('Sub', parent=styles['Normal'], fontName='Helvetica-Bold', fontSize=10, textColor=colors.HexColor('#2b6cb0'), alignment=1, spaceAfter=3)
c_style = ParagraphStyle('C', parent=styles['Normal'], fontName='Helvetica', fontSize=8, textColor=colors.HexColor('#4a5568'), alignment=1, spaceAfter=8)
sec_style = ParagraphStyle('Sec', parent=styles['Heading2'], fontName='Helvetica-Bold', fontSize=9.5, textColor=colors.HexColor('#1a365d'), spaceBefore=6, spaceAfter=3)
b_style = ParagraphStyle('B', parent=styles['Normal'], fontName='Helvetica', fontSize=8, textColor=colors.HexColor('#2d3748'), spaceAfter=2.5)
...
story = [
    ...
    Paragraph("<b>Freelance Software Engineer & AI Code Evaluator</b> <font color='#718096' size=7.5><b>(2024 – Present)</b></font>", b_style),
    ...
    Paragraph("<b>Faculty of Law — Alexandria University, Egypt</b> <font color='#718096' size=7.5><b>(Expected Graduation: 2030)</b></font>", b_style),
...
doc.build(story)
print("\n[+] Full CV generated successfully in Downloads: Mohamed_Ramadan_Elnemer_CV.pdf\n")
